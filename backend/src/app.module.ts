...
import { BookSaveModule } from './apis/booksave/booksave.module';
...
import { BookSave } from './apis/booksave/entities/booksave.entity';
import { Book } from './apis/book/entities/book.entity';
...
@Module({
  imports: [
    ...
    // User 엔티티 등록
    TypeOrmModule.forFeature([User, BookSave]),
  ],
  controllers: [],
