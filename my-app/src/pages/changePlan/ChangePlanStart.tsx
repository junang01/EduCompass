...
import './changePlanStart.css';
import { Link, useNavigate } from 'react-router-dom';

const ChangePlanStartPage: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="change-main_container">
        <div className="change-main_container_center">
          <div className="change-container_left">
            <img src="/img/compass.png" alt="compass" />
          </div>

          <div className="change-container_right">
            ...
            <div className="makeBtn_box">
              <button className="makeStartBtn" onClick={() => navigate('/changePlanSurvey1')}>
                계획 조정 시작
              </button>
            </div>
          </div>
...
export default ChangePlanStartPage;
