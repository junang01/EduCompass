...
import './bookSurveyStart.css';
import { Link, useNavigate } from 'react-router-dom';

const BookSurveyStartPage: React.FC = () => {
    ...
    <>
      ...
      <div className="sidebar">
        ...
        <ul className="sidebar-menu">
          <li className="active"><Link to="/bookSurvey1">교재 추천 받기</Link></li>
          <li><Link to="/bookSurveyResult">교재 추천 목록</Link></li>
          <hr />
        </ul>
      </div>

      <div className="book-main_container">
        <div className="book-main_container_center">
          <div className="book-container_left">
            <img src="/img/compass.png" alt="compass" />
          </div>

          <div className="book-container_right">
            ...
            <div className="makeBtn_box">
              <button className="makeStartBtn" onClick={() => navigate('/bookSurvey1')}>
                검사 실시하기
              </button>
            </div>
...
export default BookSurveyStartPage;
